...
- Name: editor.spec.js >> Editor Functionality >> Placing a cell on the editor canvas updates organism size
- Location: tests\editor.spec.js:31:3
...
Call log:
  - waiting for locator('.cell-type#common')
    - locator resolved to <div id="common" class="cell-type" title="Common: A basic structural cell with no special abilities."></div>
...
- generic [active]:
  - generic [ref=e3]:
    - generic [ref=e4]:
      ...
      - paragraph [ref=e26]: "Actual FPS: 62"
    ...
    - generic [ref=e33]:
      ...
      - generic [ref=e42]:
        ...
        - generic [ref=e65]:
          ...
          - paragraph [ref=e67]: "Species name: t6t75auwax"
